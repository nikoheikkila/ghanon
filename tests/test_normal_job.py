...
class TestNormalJob:
    ...
    def test_with_steps(self, minimal_config):
        command = "echo test"
    ...
    def test_environment_string(self, minimal_config):
    ...
    def test_environment_object(self, minimal_config):
        environment = "production"
    ...
    def test_outputs(self, minimal_config):
    ...
    def test_env(self, minimal_config):
        port = 3000
    ...
    def test_services(self, minimal_config):
        job = NormalJob.model_validate(
            {
                **minimal_config,
                "services": {
    ...
    def test_expression_in_timeout(self, minimal_config):
